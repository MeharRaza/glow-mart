...
cat("Kitchenware","🍽️","https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=100",
...
cat("Fashion Accessories","👜","https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=100",
...
cat("Home Essentials","🏠","https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=100",
...
cat("Bedding","🛏️","https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=100",
...
cat("Shoes","👠","https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=100",
...
cat("Festive Collection","🎉","https://images.unsplash.com/photo-1594938298603-c8148c4b4aea?w=100",
...
cat("Islamic Accessories","🕌","https://images.unsplash.com/photo-1609081219090-a6d81d3085bf?w=100",
    ["Prayer Mats","Tasbeeh","Caps","Abaya",
     "Scarf","Umrah Accessories","Romal"],28),

cat("Mother & Baby","👶","https://images.unsplash.com/photo-1515488042361-ee00e0ddd4e4?w=100",
    ["Baby Bags","Feeder & Pacifier","Baby Accessories","Baby Toys",
     "Baby Shoes","Baby Health","Diapers","Baby Clothes","Baby Care"],29),

cat("Women Undergarments","👙","https://images.unsplash.com/photo-1581044777550-4cfa60707c03?w=100",
    ["Bras","Bra Sets","Panties","Lingerie",
     "Women's Thermals","Camisoles","Undergarment Accessories"],30),

cat("Men's Undergarments","👕","https://images.unsplash.com/photo-1598032895397-b9472444bf93?w=100",
...
cat("Electronic Accessories","🎧","https://images.unsplash.com/photo-1606220945770-b5b6c2c55bf1?w=100",
...
cat("Perfumes","🧴","https://images.unsplash.com/photo-1541643600914-78b084683702?w=100",
    ["Women's Perfumes","Men's Perfumes","Perfume Oil","Unisex Perfumes"],34),

cat("Men's Shawls","🧣","https://images.unsplash.com/photo-1601924994987-69e26d50dc26?w=100",
    ["Wool Shawls","Cotton Shawls","Velvet Shawls"],35),

cat("Women's Shawls","🧣","https://images.unsplash.com/photo-1601924994987-69e26d50dc26?w=100",
    ["Pashmina Shawls","Cashmere Shawls","Cape Shawls","Lawn Shawls",
     "Woolen Shawls","Linen Shawls","Swiss Shawls","Velvet Shawls"],36),

cat("Bags","👝","https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=100",
    ["Travel Bags","Duffel Bags","Crossbody Bags","Laptop Bags"],37),

cat("Home Linen","🏡","https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=100",
    ["Sofa Covers","Towels","Covers","Curtains",
     "Cushion Covers","Anti Covers","Kitchen & Table Linen"],38),

cat("Auto & Bike Accessories","🚗","https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=100",
    ["Car Accessories","Bike Accessories","Bi-Cycle Accessories"],39),

cat("Fitness","💪","https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=100",
    ["Gym","Sports"],40),

cat("Unisex Clothing","👕","https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=100",
    ["Unisex Shirts","Unisex Tracksuit"],41),

cat("Other","🎁","https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=100",
    ["Gift Items"],42),
]
